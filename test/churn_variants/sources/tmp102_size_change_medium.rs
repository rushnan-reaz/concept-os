...
/// Tracks the minimum and maximum temperature seen since boot, in addition
/// to the last instantaneous reading. Used to give the LED a richer signal
/// than a plain per-sample toggle (see `TMP102::read_temperature`).
